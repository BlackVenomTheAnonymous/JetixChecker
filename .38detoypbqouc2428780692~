      ...
      <div class="p-3">
         ...
         <div class="col-md-3 mb-2">
               <div class="card h-100 bvborder">
                  ...
                  <div class="card-footer"> <center>WARNING!<br>THIS IS NOT FOR SALE!</center></div>
            ...
            <div class="col-md-3 mb-2">
               <div class="card h-100 bvborder">
                  <div class="card-header text-center">Jetix</div>
                  <div class="card-body">
                     <div id="response">
                     <img src="assets/img/blackvatican.png" class="bvlogo">
                     </div>                  
                  </div>
